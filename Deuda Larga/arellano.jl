...
function update_q!(dd::Default; tol = 1e-7, maxiter = 2000, verbose = false)
...
function eqm!(dd::Default; tol = 1e-7, maxiter = 250, verbose=true)
...
function mpe!(dd::Default; tol = 1e-3, maxiter = 500, verbose=true)
	new_v = similar(dd.v)
	new_q = similar(dd.q)
