include("deuda.jl")
abstract type Default <: Deuda end #Hay algo que se llama Default que es un tipo de Deuda

struct Arellano <: Default  # Hay algo que se llama Arellano que es un suptipo de Default y de Deuda 
